    ...
    public class CircleTest
    {
        ...
        private static List<CircleTestCase> testCases = new List<CircleTestCase>()
        {
            ...
            new CircleTestCase()
            {
                ...
                Ray = new Ray() { Origin = new Vector2(0, 2), Direction = new Vector2(1, 0), T=50f},
                ExpectedResult = true,
            ...
            {
                Circle = new Circle() { Position = new Vector2(2, 2), Radius = 1f},
                Ray = new Ray() { Origin = new Vector2(2, 4), Direction = new Vector2(0, -1),  T=50f},
                ExpectedResult = true,
            ...
            {
                Circle = new Circle() { Position = new Vector2(2, 2), Radius = 1f},
                Ray = new Ray() { Origin = new Vector2(4, 2), Direction = new Vector2(-1, 0),  T=50f},
                ExpectedResult = true,
            ...
            {
                Circle = new Circle() { Position = new Vector2(0, 0), Radius = 1f},
                Ray = new Ray() { Origin = new Vector2(0, -2), Direction = new Vector2(0, 1),  T=50f},
                ExpectedResult = true,
            ...
            {
                Circle = new Circle() { Position = new Vector2(0, 0), Radius = 1f},
                Ray = new Ray() { Origin = new Vector2(-4, 4), Direction = new Vector2(1, -1),  T=50f},
                ExpectedResult = true,
            ...
            new CircleTestCase()
            {
                ...
                Ray = new Ray() { Origin = new Vector2(0, 3), Direction = new Vector2(1, 0),  T=50f},
                ExpectedResult = true,
            ...
            {
                Circle = new Circle() { Position = new Vector2(4, 4), Radius = 1f},
                Ray = new Ray() { Origin = new Vector2(0, 10), Direction = new Vector2(1, 0),  T=50f},
            ...
            {
                Circle = new Circle() { Position = new Vector2(4, 4), Radius = 1f},
                Ray = new Ray() { Origin = new Vector2(0, 0), Direction = new Vector2(0, 1),  T=50f},
                ExpectedResult = false,
            ...
            {
                Circle = new Circle() { Position = new Vector2(4, 4), Radius = 1f},
                Ray = new Ray() { Origin = new Vector2(6, 0), Direction = new Vector2(0, 1),  T=50f},
                ExpectedResult = false,
